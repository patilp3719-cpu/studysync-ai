      ...
      <div className="px-4 py-5 border-b border-gray-700/50">
        <div className="flex items-center gap-2 mb-1">
          <div className="w-8 h-8 rounded-lg bg-gray-700 border border-gray-600 flex items-center justify-center">
            <IconCode size={16} className="text-gray-300" />
          </div>
          <span className="font-bold text-white text-base">Dev Zone</span>
        </div>
        <p className="text-xs text-gray-500 ml-10">StudySync AI</p>
      </div>

      {/* Nav */}
      <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
        <p className="text-xs font-bold text-gray-600 uppercase tracking-widest px-3 mb-2">Developer Tools</p>
        ...
        <div className="pt-4 border-t border-gray-700/50 mt-4">
          ...
          <button
            ...
            <IconGamepad size={17} className="shrink-0" />
    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-gray-900 border-b border-gray-700 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded bg-gray-700 border border-gray-600 flex items-center justify-center">
            <IconCode size={13} className="text-gray-300" />
          </div>
          <span className="font-bold text-white">Dev Zone</span>
        </div>
